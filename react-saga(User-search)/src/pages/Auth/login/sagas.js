...
//delete//import { browserHistory } from 'react-router'
...
function* loginFlow (email, password) {
  ...
  try {
    ...
    console.log(token);
    //yield effects.put(redirectRoute('/app'));
    //yield browserHistory.push('/app')
    //const history = createBrowserHistory();
    //yield this.context.router.transitionTo('/app');

    //yield put(push('/app'));
    // inform Redux to set our client token, this is non blocking so...
    //delete//yield put(setClient(token))
